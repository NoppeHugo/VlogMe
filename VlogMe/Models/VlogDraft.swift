...
struct VlogDraft: Identifiable, Codable {
    ...
    // MARK: - Cartons de ville (la ville s'affiche 3 s à chaque changement)
    var cityCardsEnabled: Bool
    ...
    init(id: UUID = UUID(), name: String = "") {
        ...
        // Activé par défaut : n'apparaît de toute façon que si le vlog traverse
        // au moins deux villes différentes.
        cityCardsEnabled = true
        isShared = false
        collabZoneName = nil
        collabOwnerName = nil
        maxParticipants = 4
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case beatSyncEnabled, cityCardsEnabled
    ...
    init(from decoder: Decoder) throws {
        ...
        cityCardsEnabled      = try c.decodeIfPresent(Bool.self, forKey: .cityCardsEnabled) ?? true
